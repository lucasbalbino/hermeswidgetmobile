...
/**
 * Vocabulary definitions from ssn.owl 
 * @author Auto-generated by schemagen on 18 mai 2017 22:58 
 */
public class SSN {
    ...
    /** <p>Rebadged as phenomenon time in [O&amp;M]. The phenomenon time shall describe 
     *  the time that the result applies to the property of the feature-of-interest. 
     *  This is often the time of interaction by a sampling procedure or observation 
     *  procedure with a real-world feature.The sampling time is the time that the 
     *  result applies to the feature-of-interest. This is the time usually required 
     *  for geospatial analysis of the result.</p>
     */
