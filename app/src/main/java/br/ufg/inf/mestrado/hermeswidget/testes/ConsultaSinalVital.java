...
public class ConsultaSinalVital {
	...
	public static void main(String[] args) {
		...
		// Consulta SPARQL sobre os individuos armazenados
...
//
//		System.out.println("\n\n\n################################################################  "
//				+ "MEDICOES DE TEMPERATURA DE UM DETERMINADO PACIENTE  "
//				+ "#############################################################################");
//		h.consultar(queryTemperataure);
//		System.out.println("\n\n\n################################################################  "
//				+ "MEDICOES DE FREQUENCIA DE PULSO DE UM DETERMINADO PACIENTE  "
//				+ "#############################################################################");
//		h.consultar(queryPulseRate);
//		System.out.println("\n\n\n################################################################  "
//				+ "MEDICOES DE PRESSAO ARTERIAL DE UM DETERMINADO PACIENTE  "
//				+ "#############################################################################");
//		h.consultar(queryBloodPressure);
//		System.out.println("\n\n\n################################################################  "
//				+ "MEDICOES DE FREQUENCIA RESPIRATORIA DE UM DETERMINADO PACIENTE  "
//				+ "#############################################################################");
//		h.consultar(queryRespiratoryRate);
//		System.out.println("\n\n\n################################################################  "
//				+ "MEDICOES DE SATURACAO DE OXIGENIO DE UM DETERMINADO PACIENTE  "
//				+ "#############################################################################");
